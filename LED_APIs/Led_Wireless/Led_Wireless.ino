...
#define WLAN_SSID       "Baobaos_NH"        // cannot be longer than 32 characters!
#define WLAN_PASS       "dblsai1221"
...
void loop(void) {
  ...
  String tmp = String(currentTime);
  tmp = tmp.substring(6,10);
  Serial.println("after trunck" + tmp);
  tmp.toCharArray(displaybuffer,5);
  delay(8000L); // Pause 15 seconds
}
